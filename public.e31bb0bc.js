...
},{"moment":"../node_modules/moment/moment.js"}],"../node_modules/lodash/isArray.js":[function(require,module,exports) {
/**
...
},{"./_baseGet":"../node_modules/lodash/_baseGet.js"}],"js/main.js":[function(require,module,exports) {
"use strict";
...
var _default = function _default(fields) {
  var ctx = document.getElementById('mpg-time').getContext('2d');
...
function shapeData(fields) {
  var data = fields.reduce(function (acc, val, index, arr) {
    if (index > 0) {
      var _val = _slicedToArray(val, 4),
          date = _val[0],
          mileage = _val[1],
          gallons = _val[2],
          price = _val[3];

      var prevMileage = arr[index - 1][1];
      var miles = mileage - prevMileage;
      acc.push({
        x: new Date(date),
        y: miles / gallons
      });
  ...
  return {
    ...
    datasets: [_defineProperty({
      label: 'mpg',
      data: data,
      backgroundColor: _chart.default.helpers.color(chartColors.red).alpha(0.5).rgbString(),
...
},{"chart.js":"../node_modules/chart.js/dist/Chart.js","lodash/get":"../node_modules/lodash/get.js"}],"../node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../node_modules/unfetch/dist/unfetch.mjs":[function(require,module,exports) {
"use strict";
...
},{}],"../mpg.csv":[function(require,module,exports) {
module.exports = "/mpg.651a8aa6.csv";
...
var _mpg = _interopRequireDefault(require("../mpg.csv"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _unfetch.default)(_mpg.default).then(getData).then(parseCsv).then(_main.default).catch(console.error);
...
},{"./js/main":"js/main.js","./main.css":"main.css","unfetch":"../node_modules/unfetch/dist/unfetch.mjs","../mpg.csv":"../mpg.csv"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "11323" + '/');

...
var _mpgCsv = require("url:../mpg.csv");
var _mpgCsvDefault = parcelHelpers.interopDefault(_mpgCsv);
(0, _mainDefault.default)((0, _mpgCsvDefault.default));

},{"./main.css":"5d8d2","./js/main":"1SICI","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","url:../mpg.csv":"6CcGR"}],"5d8d2":[function() {},{}],"1SICI":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
exports.default = (csv)=>{
    (0, _unfetchDefault.default)(csv).then(deserialize).then(parse).then(setup).catch(console.error);
};
...
function calculateSum(table, columnId) {
    ...
    const sum = table.slice(1).reduce((acc, val, index)=>{
        if (!(0, _utils.isEmpty)(val[column])) {
            const value = Number(val[column]);
            if (!isNaN(value)) return acc + value;
            else console.error(`Unable to sum bad value in column '${header[column]}' with value '${val[column]}' on line ${index + 2}`);
        }
        return acc;
    }, 0);
...
function calculateDistance(table) {
    ...
    let i = 1;
    while((0, _utils.isEmpty)(lastValue) && i < 2){
        i++;
...
},{"unfetch":"3Bubp","./chart":"4jBvm","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./utils":"72Dku"}],"3Bubp":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const renderCanvas = ({ rootId , ariaLabel , canvasId  })=>{
    ...
    div.innerHTML = (0, _templates.canvas)({
        ariaLabel,
        id: canvasId
    });
    document.getElementById(rootId).appendChild(div);
};
exports.default = ({ rootId , table  })=>{
    ...
    new (0, _chartJsDefault.default)(ctx, {
        type: "line",
        ...
        datasets: [
            {
                ...
                backgroundColor: (0, _chartJsDefault.default).helpers.color((0, _utils.colors).green).alpha(0.5).rgbString(),
                ...
                lineTension: 0,
                borderWidth: 2,
                yAxisID: (0, _utils.ids).PRICE_ID
            },
            {
                label: (0, _utils.labels).MPG,
                ...
                backgroundColor: (0, _chartJsDefault.default).helpers.color((0, _utils.colors).red).alpha(0.5).rgbString(),
                ...
                lineTension: 0,
                borderWidth: 2,
                yAxisID: (0, _utils.ids).MPG_ID
            },
            {
                label: (0, _utils.labels).MILEAGE,
                data: table.reduce((acc, val, index, arr)=>{
                    const [date, mileage, gallons, price] = val;
                    if (index > 0 && date) {
                        acc.push({
                ...
                backgroundColor: (0, _chartJsDefault.default).helpers.color((0, _utils.colors).blue).alpha(0.5).rgbString(),
                ...
                lineTension: 0,
                borderWidth: 2,
                yAxisID: (0, _utils.ids).MILEAGE_ID
            }
        ]
    };
}
        ...
        tooltips: {
            ...
            callbacks: {
                label: function(tooltipItem, myData) {
                    ...
                    if (label) label += ": ";
                    const priceIndex = (0, _findIndexDefault.default)(myData.datasets, {
                        label: (0, _utils.labels).PRICE
                    });
                    const mileageIndex = (0, _findIndexDefault.default)(myData.datasets, {
                        label: (0, _utils.labels).MILEAGE
                    });
                    if (tooltipItem.datasetIndex === priceIndex) label += "$";
                    if (tooltipItem.datasetIndex === mileageIndex) label += tooltipItem.value;
                    else label += parseFloat(tooltipItem.value).toFixed(2);
                    return label;
                }
            }
        }
...
},{"chart.js":"kmlOB","./templates":"18mfC","./utils":"72Dku","lodash/findIndex":"5OrPR","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kmlOB":[function(require,module,exports) {
/*!
 * Chart.js v2.9.4
 ...
 */ (function(global, factory) {
    module.exports = factory(function() {
        try {
            return require("1b48d7a1ca747077");
        } catch (e) {}
    }());
...
},{"1b48d7a1ca747077":"jwcsj"}],"jwcsj":[function(require,module,exports) {
//! moment.js
//! version : 2.29.4
...
var _templateSettings = require("lodash/templateSettings");
var _templateSettingsDefault = parcelHelpers.interopDefault(_templateSettings);
(0, _templateSettingsDefault.default).interpolate = /\{\{(.+?)\}\}/g;
const canvas = (0, _templateDefault.default)(`
  <canvas
    id="{{ id }}"
    width="800"
    height="400"
...
},{"lodash/template":"476v3","lodash/templateSettings":"79x7E","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"476v3":[function(require,module,exports) {
var assignInWith = require("b8eede48fac2121a"), attempt = require("aab2155c6b88a2c0"), baseValues = require("c70233e5bc55a2c1"), customDefaultsAssignIn = require("aa771aea4b1925d"), escapeStringChar = require("47357003c1e54240"), isError = require("7fb429bca2da6e3f"), isIterateeCall = require("97ca97da117bcc9f"), keys = require("79c66b72f604a0c8"), reInterpolate = require("bb641fabf35342dd"), templateSettings = require("64b28b711a2b7240"), toString = require("d734d2e5f193796b");
...
},{"b8eede48fac2121a":"7Hhut","aab2155c6b88a2c0":"ifQWs","c70233e5bc55a2c1":"1CRl4","aa771aea4b1925d":"eIhbe","47357003c1e54240":"5yG4k","7fb429bca2da6e3f":"8frBY","97ca97da117bcc9f":"7JSn7","79c66b72f604a0c8":"6fHVw","bb641fabf35342dd":"3k4w4","64b28b711a2b7240":"79x7E","d734d2e5f193796b":"joIdQ"}],"7Hhut":[function(require,module,exports) {
var copyObject = require("d95e6082c63fad66"), createAssigner = require("4b1967feb7712f1f"), keysIn = require("e1df9f1e84fa5207");
/**
...
},{"d95e6082c63fad66":"gfA7W","4b1967feb7712f1f":"7RrvA","e1df9f1e84fa5207":"c9sMs"}],"gfA7W":[function(require,module,exports) {
var assignValue = require("b1b0aeb4cab0f389"), baseAssignValue = require("a5e9c1d5f667edcc");
/**
...
},{"b1b0aeb4cab0f389":"5M3eX","a5e9c1d5f667edcc":"fprBU"}],"5M3eX":[function(require,module,exports) {
var baseAssignValue = require("33f24dfb0e675d4f"), eq = require("b2c4e059cc9a3fa9");
/** Used for built-in method references. */ var objectProto = Object.prototype;
/** Used to check objects for own properties. */ var hasOwnProperty = objectProto.hasOwnProperty;
/**
...
},{"33f24dfb0e675d4f":"fprBU","b2c4e059cc9a3fa9":"aVz5f"}],"fprBU":[function(require,module,exports) {
var defineProperty = require("f8df6fae63f801c4");
/**
...
},{"f8df6fae63f801c4":"cZOnw"}],"cZOnw":[function(require,module,exports) {
var getNative = require("7323893b455246f5");
...
},{"7323893b455246f5":"9PCIl"}],"9PCIl":[function(require,module,exports) {
var baseIsNative = require("59c2aa6592301bcc"), getValue = require("4223398db080e1f1");
/**
...
},{"59c2aa6592301bcc":"2U9Pn","4223398db080e1f1":"kKx5I"}],"2U9Pn":[function(require,module,exports) {
var isFunction = require("628963694674ad4f"), isMasked = require("fa35ad62f5d407f2"), isObject = require("809bd19e69fbb9fc"), toSource = require("ce53850d59546202");
/**
...
},{"628963694674ad4f":"cfti6","fa35ad62f5d407f2":"cMDzi","809bd19e69fbb9fc":"cGhqJ","ce53850d59546202":"bYHc7"}],"cfti6":[function(require,module,exports) {
var baseGetTag = require("ea0095df7e6cb742"), isObject = require("63f22cfc401df957");
...
},{"ea0095df7e6cb742":"lOnbo","63f22cfc401df957":"cGhqJ"}],"lOnbo":[function(require,module,exports) {
var Symbol = require("8e315a35ec48c506"), getRawTag = require("222dc233c49d9ce"), objectToString = require("90f4f4e524b240c6");
...
},{"8e315a35ec48c506":"7lsL9","222dc233c49d9ce":"995sO","90f4f4e524b240c6":"bmE3g"}],"7lsL9":[function(require,module,exports) {
var root = require("c8258b22dce5ab4e");
/** Built-in value references. */ var Symbol = root.Symbol;
module.exports = Symbol;

},{"c8258b22dce5ab4e":"dSYUs"}],"dSYUs":[function(require,module,exports) {
var freeGlobal = require("ac86bca2cadeb10");
/** Detect free variable `self`. */ var freeSelf = typeof self == "object" && self && self.Object === Object && self;
/** Used as a reference to the global object. */ var root = freeGlobal || freeSelf || Function("return this")();
module.exports = root;

},{"ac86bca2cadeb10":"kAk32"}],"kAk32":[function(require,module,exports) {
/** Detect free variable `global` from Node.js. */ var global = arguments[3];
var freeGlobal = typeof global == "object" && global && global.Object === Object && global;
module.exports = freeGlobal;

},{}],"995sO":[function(require,module,exports) {
var Symbol = require("146705ad39bd442f");
/** Used for built-in method references. */ var objectProto = Object.prototype;
/** Used to check objects for own properties. */ var hasOwnProperty = objectProto.hasOwnProperty;
/**
 * Used to resolve the
...
},{"146705ad39bd442f":"7lsL9"}],"bmE3g":[function(require,module,exports) {
/** Used for built-in method references. */ var objectProto = Object.prototype;
/**
 * Used to resolve the
 * [`toStringTag`](http://ecma-international.org/ecma-262/7.0/#sec-object.prototype.tostring)
...
var coreJsData = require("ea8260630a423237");
...
},{"ea8260630a423237":"6gJwQ"}],"6gJwQ":[function(require,module,exports) {
var root = require("a5a7d350ec19943e");
/** Used to detect overreaching core-js shims. */ var coreJsData = root["__core-js_shared__"];
module.exports = coreJsData;

},{"a5a7d350ec19943e":"dSYUs"}],"bYHc7":[function(require,module,exports) {
...
var baseRest = require("59eb43027ac8659"), isIterateeCall = require("67aa5a6af87295d1");
/**
...
},{"59eb43027ac8659":"kd260","67aa5a6af87295d1":"7JSn7"}],"kd260":[function(require,module,exports) {
var identity = require("65321a3df57eafec"), overRest = require("e530e97882610419"), setToString = require("224b3c6eaf19ac9");
/**
...
},{"65321a3df57eafec":"dgTUN","e530e97882610419":"16F1z","224b3c6eaf19ac9":"b5kjI"}],"dgTUN":[function(require,module,exports) {
/**
...
var apply = require("e5f1d1706163d0ef");
...
},{"e5f1d1706163d0ef":"gUweg"}],"gUweg":[function(require,module,exports) {
/**
...
var baseSetToString = require("9e260065d3b8b2ed"), shortOut = require("7e8f39e80bc34e9d");
/**
...
},{"9e260065d3b8b2ed":"lgihM","7e8f39e80bc34e9d":"7ulLs"}],"lgihM":[function(require,module,exports) {
var constant = require("4f9d9084ba10163a"), defineProperty = require("79321ded40866de7"), identity = require("66684dbe6356ff86");
/**
...
},{"4f9d9084ba10163a":"1HI6K","79321ded40866de7":"cZOnw","66684dbe6356ff86":"dgTUN"}],"1HI6K":[function(require,module,exports) {
/**
...
var eq = require("acbb83bbef39fa0f"), isArrayLike = require("387116bee7094c74"), isIndex = require("68be0b01cea8eba8"), isObject = require("2fb2036f5217029");
/**
...
},{"acbb83bbef39fa0f":"aVz5f","387116bee7094c74":"gMCbp","68be0b01cea8eba8":"aJpx0","2fb2036f5217029":"cGhqJ"}],"gMCbp":[function(require,module,exports) {
var isFunction = require("f0c28fe66a9a10d"), isLength = require("da91e66c40c1f6b1");
/**
...
},{"f0c28fe66a9a10d":"cfti6","da91e66c40c1f6b1":"hrTBx"}],"hrTBx":[function(require,module,exports) {
...
var arrayLikeKeys = require("134351c2b351ddb5"), baseKeysIn = require("53e3db429b734a53"), isArrayLike = require("5317195bbcb14f34");
/**
...
},{"134351c2b351ddb5":"dquIQ","53e3db429b734a53":"23s7e","5317195bbcb14f34":"gMCbp"}],"dquIQ":[function(require,module,exports) {
var baseTimes = require("751501233382adb4"), isArguments = require("90b143ac8f705051"), isArray = require("2c3073bcb0f6ba3d"), isBuffer = require("3a980b5132388e5b"), isIndex = require("59794768292bfba6"), isTypedArray = require("e8f516d44bca0428");
/** Used for built-in method references. */ var objectProto = Object.prototype;
/** Used to check objects for own properties. */ var hasOwnProperty = objectProto.hasOwnProperty;
/**
...
},{"751501233382adb4":"odqYd","90b143ac8f705051":"8ReNj","2c3073bcb0f6ba3d":"dZaTH","3a980b5132388e5b":"cn85h","59794768292bfba6":"aJpx0","e8f516d44bca0428":"6SVKk"}],"odqYd":[function(require,module,exports) {
/**
...
var baseIsArguments = require("d510c65442b49450"), isObjectLike = require("40107f1569d51977");
/** Used for built-in method references. */ var objectProto = Object.prototype;
/** Used to check objects for own properties. */ var hasOwnProperty = objectProto.hasOwnProperty;
...
},{"d510c65442b49450":"gx70P","40107f1569d51977":"3BLi4"}],"gx70P":[function(require,module,exports) {
var baseGetTag = require("eb8342c79e56d827"), isObjectLike = require("e1eebffac9a03b10");
...
},{"eb8342c79e56d827":"lOnbo","e1eebffac9a03b10":"3BLi4"}],"3BLi4":[function(require,module,exports) {
/**
...
var root = require("33e134170c09d21f"), stubFalse = require("e32b5a73b4e20ddb");
...
},{"33e134170c09d21f":"dSYUs","e32b5a73b4e20ddb":"dx4uy"}],"dx4uy":[function(require,module,exports) {
/**
...
var baseIsTypedArray = require("76855b6f1ec2075"), baseUnary = require("21afdc2ce41d4617"), nodeUtil = require("3d5da75bcafcedf8");
...
},{"76855b6f1ec2075":"lGSsl","21afdc2ce41d4617":"eJXq4","3d5da75bcafcedf8":"5edNe"}],"lGSsl":[function(require,module,exports) {
var baseGetTag = require("38eb9badd1b37d9c"), isLength = require("3e4e21e6cabb4011"), isObjectLike = require("c609872b8672e25f");
...
},{"38eb9badd1b37d9c":"lOnbo","3e4e21e6cabb4011":"hrTBx","c609872b8672e25f":"3BLi4"}],"eJXq4":[function(require,module,exports) {
/**
...
var freeGlobal = require("47fda66071525497");
/** Detect free variable `exports`. */ var freeExports = exports && !exports.nodeType && exports;
/** Detect free variable `module`. */ var freeModule = freeExports && true && module && !module.nodeType && module;
/** Detect the popular CommonJS extension `module.exports`. */ var moduleExports = freeModule && freeModule.exports === freeExports;
...
},{"47fda66071525497":"kAk32"}],"23s7e":[function(require,module,exports) {
var isObject = require("589567b1319bdaf1"), isPrototype = require("c3f92871d9aa8860"), nativeKeysIn = require("51933fb9fc2d951e");
/** Used for built-in method references. */ var objectProto = Object.prototype;
/** Used to check objects for own properties. */ var hasOwnProperty = objectProto.hasOwnProperty;
/**
...
},{"589567b1319bdaf1":"cGhqJ","c3f92871d9aa8860":"iG4eR","51933fb9fc2d951e":"5CFL0"}],"iG4eR":[function(require,module,exports) {
/** Used for built-in method references. */ var objectProto = Object.prototype;
/**
...
},{}],"ifQWs":[function(require,module,exports) {
var apply = require("f1d7a8d3540ddb0f"), baseRest = require("6e595ba99ba15129"), isError = require("d8dee6fb52da198a");
/**
...
},{"f1d7a8d3540ddb0f":"gUweg","6e595ba99ba15129":"kd260","d8dee6fb52da198a":"8frBY"}],"8frBY":[function(require,module,exports) {
var baseGetTag = require("81fb5f56f0c282e5"), isObjectLike = require("fa611ab5bf19a6dd"), isPlainObject = require("41a23b917133bf90");
...
},{"81fb5f56f0c282e5":"lOnbo","fa611ab5bf19a6dd":"3BLi4","41a23b917133bf90":"cvSNF"}],"cvSNF":[function(require,module,exports) {
var baseGetTag = require("a4a9811b37ae3b9"), getPrototype = require("ee2a4d59fa86633b"), isObjectLike = require("f46e086929d99457");
...
},{"a4a9811b37ae3b9":"lOnbo","ee2a4d59fa86633b":"8ASKT","f46e086929d99457":"3BLi4"}],"8ASKT":[function(require,module,exports) {
var overArg = require("fc791139f6ef5cbb");
/** Built-in value references. */ var getPrototype = overArg(Object.getPrototypeOf, Object);
module.exports = getPrototype;

},{"fc791139f6ef5cbb":"dpUvl"}],"dpUvl":[function(require,module,exports) {
/**
...
},{}],"1CRl4":[function(require,module,exports) {
var arrayMap = require("862469bdb38d785e");
/**
...
},{"862469bdb38d785e":"imI5Z"}],"imI5Z":[function(require,module,exports) {
/**
...
},{}],"eIhbe":[function(require,module,exports) {
var eq = require("2c605b1d0d76e272");
/** Used for built-in method references. */ var objectProto = Object.prototype;
/** Used to check objects for own properties. */ var hasOwnProperty = objectProto.hasOwnProperty;
/**
...
},{"2c605b1d0d76e272":"aVz5f"}],"5yG4k":[function(require,module,exports) {
...
var arrayLikeKeys = require("a66054d9924a954e"), baseKeys = require("dba218fe6315197d"), isArrayLike = require("d4d726a130fca503");
/**
...
},{"a66054d9924a954e":"dquIQ","dba218fe6315197d":"c0eiI","d4d726a130fca503":"gMCbp"}],"c0eiI":[function(require,module,exports) {
var isPrototype = require("d0b915773fd96c7b"), nativeKeys = require("69818431a9f02026");
/** Used for built-in method references. */ var objectProto = Object.prototype;
/** Used to check objects for own properties. */ var hasOwnProperty = objectProto.hasOwnProperty;
/**
...
},{"d0b915773fd96c7b":"iG4eR","69818431a9f02026":"k97u2"}],"k97u2":[function(require,module,exports) {
var overArg = require("6bea1ed5871b8d26");
/* Built-in method references for those with the same name as other `lodash` methods. */ var nativeKeys = overArg(Object.keys, Object);
module.exports = nativeKeys;

},{"6bea1ed5871b8d26":"dpUvl"}],"3k4w4":[function(require,module,exports) {
/** Used to match template delimiters. */ var reInterpolate = /<%=([\s\S]+?)%>/g;
module.exports = reInterpolate;

},{}],"79x7E":[function(require,module,exports) {
var escape = require("5913696f72a7a2bc"), reEscape = require("3d5afb489396909"), reEvaluate = require("664bb68dbe5d7c07"), reInterpolate = require("f6369b4085e31fa3");
/**
...
},{"5913696f72a7a2bc":"dMTR4","3d5afb489396909":"kuhUr","664bb68dbe5d7c07":"ayfru","f6369b4085e31fa3":"3k4w4"}],"dMTR4":[function(require,module,exports) {
var escapeHtmlChar = require("2169d5b7c31edf2b"), toString = require("359564d5087178b6");
...
},{"2169d5b7c31edf2b":"1K88Y","359564d5087178b6":"joIdQ"}],"1K88Y":[function(require,module,exports) {
var basePropertyOf = require("c2359189101a5d88");
...
},{"c2359189101a5d88":"7Cs1k"}],"7Cs1k":[function(require,module,exports) {
/**
...
},{}],"joIdQ":[function(require,module,exports) {
var baseToString = require("c754e1a8589192b5");
/**
...
},{"c754e1a8589192b5":"goDP8"}],"goDP8":[function(require,module,exports) {
var Symbol = require("eae1edbdec900612"), arrayMap = require("a215b193d86aa32e"), isArray = require("7223a8e678e5ede5"), isSymbol = require("f75e5200eff3306");
...
},{"eae1edbdec900612":"7lsL9","a215b193d86aa32e":"imI5Z","7223a8e678e5ede5":"dZaTH","f75e5200eff3306":"i3BHC"}],"i3BHC":[function(require,module,exports) {
var baseGetTag = require("807aa233c1c3908f"), isObjectLike = require("e295599465485d9f");
...
},{"807aa233c1c3908f":"lOnbo","e295599465485d9f":"3BLi4"}],"kuhUr":[function(require,module,exports) {
/** Used to match template delimiters. */ var reEscape = /<%-([\s\S]+?)%>/g;
module.exports = reEscape;

},{}],"ayfru":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5OrPR":[function(require,module,exports) {
var baseFindIndex = require("2fdc10f1fc45c283"), baseIteratee = require("f26c15b2ced0267c"), toInteger = require("54f6e0b0b91a527e");
/* Built-in method references for those with the same name as other `lodash` methods. */ var nativeMax = Math.max;
/**
...
},{"2fdc10f1fc45c283":"630D7","f26c15b2ced0267c":"2fsgg","54f6e0b0b91a527e":"ds6ZT"}],"630D7":[function(require,module,exports) {
/**
...
var baseMatches = require("128cce9976e6135c"), baseMatchesProperty = require("d9e2aa2975b122a5"), identity = require("a62b782642b8009d"), isArray = require("fc3526ce8694998b"), property = require("56b6363d8220ce95");
/**
...
},{"128cce9976e6135c":"2mdwX","d9e2aa2975b122a5":"48kxC","a62b782642b8009d":"dgTUN","fc3526ce8694998b":"dZaTH","56b6363d8220ce95":"8aSQI"}],"2mdwX":[function(require,module,exports) {
var baseIsMatch = require("c759e8c49304ce2c"), getMatchData = require("6e229d348f1a4fe1"), matchesStrictComparable = require("a81b7329104d3cc9");
/**
...
},{"c759e8c49304ce2c":"joJZV","6e229d348f1a4fe1":"48Qyi","a81b7329104d3cc9":"a9Bav"}],"joJZV":[function(require,module,exports) {
var Stack = require("4ca82c744472c852"), baseIsEqual = require("df6e69ff3a75dbae");
...
},{"4ca82c744472c852":"atP87","df6e69ff3a75dbae":"7i3qr"}],"atP87":[function(require,module,exports) {
var ListCache = require("b824feaff28e8de4"), stackClear = require("4ef6f030c72b9ab2"), stackDelete = require("b7d51123cc3d7d10"), stackGet = require("b65cc533bbb6ba9d"), stackHas = require("e4827f61f9d86e51"), stackSet = require("4cf0e14b58863dd0");
/**
...
},{"b824feaff28e8de4":"3UZeo","4ef6f030c72b9ab2":"6CpyN","b7d51123cc3d7d10":"dGFb0","b65cc533bbb6ba9d":"6zFUp","e4827f61f9d86e51":"3VJUX","4cf0e14b58863dd0":"ZfrYM"}],"3UZeo":[function(require,module,exports) {
var listCacheClear = require("caf10ae4be47bd3"), listCacheDelete = require("fdbf6f7d829535b7"), listCacheGet = require("1bc160a8817b34b2"), listCacheHas = require("a554bf069c36c5e8"), listCacheSet = require("8b9edf189d7eadd4");
/**
...
},{"caf10ae4be47bd3":"7AKQv","fdbf6f7d829535b7":"j2Z5O","1bc160a8817b34b2":"6Zrrs","a554bf069c36c5e8":"i1CBK","8b9edf189d7eadd4":"2Rcur"}],"7AKQv":[function(require,module,exports) {
/**
...
var assocIndexOf = require("415515bfa4980c40");
...
},{"415515bfa4980c40":"cRVsl"}],"cRVsl":[function(require,module,exports) {
var eq = require("403bbb2d9343f01d");
/**
...
},{"403bbb2d9343f01d":"aVz5f"}],"6Zrrs":[function(require,module,exports) {
var assocIndexOf = require("7a5051f4109f0b48");
/**
...
},{"7a5051f4109f0b48":"cRVsl"}],"i1CBK":[function(require,module,exports) {
var assocIndexOf = require("8270634d9658d54f");
/**
...
},{"8270634d9658d54f":"cRVsl"}],"2Rcur":[function(require,module,exports) {
var assocIndexOf = require("ee675efa7e3cd87f");
/**
...
},{"ee675efa7e3cd87f":"cRVsl"}],"6CpyN":[function(require,module,exports) {
var ListCache = require("6a3afe6c80e87c1b");
/**
...
},{"6a3afe6c80e87c1b":"3UZeo"}],"dGFb0":[function(require,module,exports) {
/**
...
var ListCache = require("50151db673468a63"), Map = require("8e9d2007cdc605c6"), MapCache = require("8abfebd895d17bba");
...
},{"50151db673468a63":"3UZeo","8e9d2007cdc605c6":"8YjF4","8abfebd895d17bba":"664I1"}],"8YjF4":[function(require,module,exports) {
var getNative = require("12a8918ffdbfe08d"), root = require("d421316e0703ae00");
/* Built-in method references that are verified to be native. */ var Map = getNative(root, "Map");
module.exports = Map;

},{"12a8918ffdbfe08d":"9PCIl","d421316e0703ae00":"dSYUs"}],"664I1":[function(require,module,exports) {
var mapCacheClear = require("7a6eeaaf64a0b09f"), mapCacheDelete = require("511f07473c5e138f"), mapCacheGet = require("b419c0bbbec70edc"), mapCacheHas = require("237a8756880c251"), mapCacheSet = require("e02849355138ce9d");
/**
...
},{"7a6eeaaf64a0b09f":"7kHs4","511f07473c5e138f":"4ny9y","b419c0bbbec70edc":"gVeFY","237a8756880c251":"idSOY","e02849355138ce9d":"lXUJT"}],"7kHs4":[function(require,module,exports) {
var Hash = require("574bce873e42f98f"), ListCache = require("e3da5f7c4b586d5e"), Map = require("247505cc720959ce");
/**
...
},{"574bce873e42f98f":"jFMT5","e3da5f7c4b586d5e":"3UZeo","247505cc720959ce":"8YjF4"}],"jFMT5":[function(require,module,exports) {
var hashClear = require("42736aeac082ff"), hashDelete = require("8b723f92a4cc73f8"), hashGet = require("5fb5ac58532b0dc9"), hashHas = require("d87de63a62489d0a"), hashSet = require("1f64fdf547a9dd2f");
/**
...
},{"42736aeac082ff":"f2NRo","8b723f92a4cc73f8":"cCdgz","5fb5ac58532b0dc9":"eKqTO","d87de63a62489d0a":"ghnqP","1f64fdf547a9dd2f":"6i99R"}],"f2NRo":[function(require,module,exports) {
var nativeCreate = require("c1825a126b56feff");
/**
...
},{"c1825a126b56feff":"6i8Uf"}],"6i8Uf":[function(require,module,exports) {
var getNative = require("2a23211938c75874");
/* Built-in method references that are verified to be native. */ var nativeCreate = getNative(Object, "create");
module.exports = nativeCreate;

},{"2a23211938c75874":"9PCIl"}],"cCdgz":[function(require,module,exports) {
/**
...
var nativeCreate = require("cdfaa6b2094a9a9f");
...
},{"cdfaa6b2094a9a9f":"6i8Uf"}],"ghnqP":[function(require,module,exports) {
var nativeCreate = require("7ac4755953dbc89a");
/** Used for built-in method references. */ var objectProto = Object.prototype;
/** Used to check objects for own properties. */ var hasOwnProperty = objectProto.hasOwnProperty;
/**
...
},{"7ac4755953dbc89a":"6i8Uf"}],"6i99R":[function(require,module,exports) {
var nativeCreate = require("23a8b677ee1460ae");
/** Used to stand-in for `undefined` hash values. */ var HASH_UNDEFINED = "__lodash_hash_undefined__";
/**
...
},{"23a8b677ee1460ae":"6i8Uf"}],"4ny9y":[function(require,module,exports) {
var getMapData = require("ce152869b523d1aa");
/**
...
},{"ce152869b523d1aa":"aptgk"}],"aptgk":[function(require,module,exports) {
var isKeyable = require("d290fa82a7a7a431");
/**
...
},{"d290fa82a7a7a431":"icylN"}],"icylN":[function(require,module,exports) {
/**
...
var getMapData = require("da0e7572abc0303d");
/**
...
},{"da0e7572abc0303d":"aptgk"}],"idSOY":[function(require,module,exports) {
var getMapData = require("7f9d3ae5945c895a");
/**
...
},{"7f9d3ae5945c895a":"aptgk"}],"lXUJT":[function(require,module,exports) {
var getMapData = require("a6571b821c6f090d");
/**
...
},{"a6571b821c6f090d":"aptgk"}],"7i3qr":[function(require,module,exports) {
var baseIsEqualDeep = require("1f4abc457862bf9c"), isObjectLike = require("9f733c0df3ae05ac");
/**
...
},{"1f4abc457862bf9c":"6GoQ9","9f733c0df3ae05ac":"3BLi4"}],"6GoQ9":[function(require,module,exports) {
var Stack = require("bb260a6ac1a66e68"), equalArrays = require("23674366f539e2c9"), equalByTag = require("1d3c75037d325230"), equalObjects = require("cf006d707bc2f489"), getTag = require("b523a7b0443ea3c6"), isArray = require("4116e27107203d38"), isBuffer = require("b3f7e913a7be793d"), isTypedArray = require("87ec10ffd3357943");
...
},{"bb260a6ac1a66e68":"atP87","23674366f539e2c9":"dQBwf","1d3c75037d325230":"iqa6H","cf006d707bc2f489":"klCEf","b523a7b0443ea3c6":"cRPhM","4116e27107203d38":"dZaTH","b3f7e913a7be793d":"cn85h","87ec10ffd3357943":"6SVKk"}],"dQBwf":[function(require,module,exports) {
var SetCache = require("8f4456a0f29da971"), arraySome = require("6cd0733604135f38"), cacheHas = require("a5c8963074fab99c");
/** Used to compose bitmasks for value comparisons. */ var COMPARE_PARTIAL_FLAG = 1, COMPARE_UNORDERED_FLAG = 2;
/**
...
},{"8f4456a0f29da971":"1SXrY","6cd0733604135f38":"aLDHW","a5c8963074fab99c":"70cVb"}],"1SXrY":[function(require,module,exports) {
var MapCache = require("c43d79f8fff8de19"), setCacheAdd = require("1cd889b7ecf88d4f"), setCacheHas = require("1b1976ba96ec11fc");
/**
 *
...
},{"c43d79f8fff8de19":"664I1","1cd889b7ecf88d4f":"cZViu","1b1976ba96ec11fc":"4zNID"}],"cZViu":[function(require,module,exports) {
/** Used to stand-in for `undefined` hash values. */ var HASH_UNDEFINED = "__lodash_hash_undefined__";
/**
...
var Symbol = require("8d1b41c64a1ca0f0"), Uint8Array = require("6e51924fd7ba29ef"), eq = require("143b92099534922c"), equalArrays = require("ea92427fc52984de"), mapToArray = require("f92c250831ba070b"), setToArray = require("f2c1fb2f6a9910");
/** Used to compose bitmasks for value comparisons. */ var COMPARE_PARTIAL_FLAG = 1, COMPARE_UNORDERED_FLAG = 2;
...
},{"8d1b41c64a1ca0f0":"7lsL9","6e51924fd7ba29ef":"6xFrA","143b92099534922c":"aVz5f","ea92427fc52984de":"dQBwf","f92c250831ba070b":"kAwkU","f2c1fb2f6a9910":"2qJif"}],"6xFrA":[function(require,module,exports) {
var root = require("e86d3553251c240b");
/** Built-in value references. */ var Uint8Array = root.Uint8Array;
module.exports = Uint8Array;

},{"e86d3553251c240b":"dSYUs"}],"kAwkU":[function(require,module,exports) {
/**
...
var getAllKeys = require("1f5044ff3ffd8a8f");
/** Used to compose bitmasks for value comparisons. */ var COMPARE_PARTIAL_FLAG = 1;
/** Used for built-in method references. */ var objectProto = Object.prototype;
/** Used to check objects for own properties. */ var hasOwnProperty = objectProto.hasOwnProperty;
/**
...
},{"1f5044ff3ffd8a8f":"d2kML"}],"d2kML":[function(require,module,exports) {
var baseGetAllKeys = require("4bf38eaf172e31c2"), getSymbols = require("a6cf0d157ac32ac3"), keys = require("5dfbde2e54f2f9fe");
/**
...
},{"4bf38eaf172e31c2":"aeckf","a6cf0d157ac32ac3":"5p5Yd","5dfbde2e54f2f9fe":"6fHVw"}],"aeckf":[function(require,module,exports) {
var arrayPush = require("d9e040b7d9423163"), isArray = require("3e6bfac44f3e452b");
/**
...
},{"d9e040b7d9423163":"ivo5r","3e6bfac44f3e452b":"dZaTH"}],"ivo5r":[function(require,module,exports) {
/**
...
var arrayFilter = require("afe44770b827941d"), stubArray = require("54f18d76204ab304");
/** Used for built-in method references. */ var objectProto = Object.prototype;
/** Built-in value references. */ var propertyIsEnumerable = objectProto.propertyIsEnumerable;
...
},{"afe44770b827941d":"hmIQ7","54f18d76204ab304":"6TgRy"}],"hmIQ7":[function(require,module,exports) {
/**
...
var DataView = require("4481b56d74501f3a"), Map = require("a4a4b6e9d026c5a7"), Promise = require("cd6919f2bed5ba7"), Set = require("c921b4c3de5ebc45"), WeakMap = require("194543fd7afde347"), baseGetTag = require("9a200640399264ae"), toSource = require("8411b1dba0983ee4");
...
},{"4481b56d74501f3a":"ejRu5","a4a4b6e9d026c5a7":"8YjF4","cd6919f2bed5ba7":"jbvCt","c921b4c3de5ebc45":"4xGLf","194543fd7afde347":"av50V","9a200640399264ae":"lOnbo","8411b1dba0983ee4":"bYHc7"}],"ejRu5":[function(require,module,exports) {
var getNative = require("9cca1cf08a962903"), root = require("7d5ad74141c9da3d");
/* Built-in method references that are verified to be native. */ var DataView = getNative(root, "DataView");
module.exports = DataView;

},{"9cca1cf08a962903":"9PCIl","7d5ad74141c9da3d":"dSYUs"}],"jbvCt":[function(require,module,exports) {
var getNative = require("8bf887f456840620"), root = require("fda10aa6dc7633c5");
/* Built-in method references that are verified to be native. */ var Promise = getNative(root, "Promise");
module.exports = Promise;

},{"8bf887f456840620":"9PCIl","fda10aa6dc7633c5":"dSYUs"}],"4xGLf":[function(require,module,exports) {
var getNative = require("b2e9efc55d259188"), root = require("578ec577a313d772");
/* Built-in method references that are verified to be native. */ var Set = getNative(root, "Set");
module.exports = Set;

},{"b2e9efc55d259188":"9PCIl","578ec577a313d772":"dSYUs"}],"av50V":[function(require,module,exports) {
var getNative = require("21e90fe13f0cf344"), root = require("b7dae1f06350956d");
/* Built-in method references that are verified to be native. */ var WeakMap = getNative(root, "WeakMap");
module.exports = WeakMap;

},{"21e90fe13f0cf344":"9PCIl","b7dae1f06350956d":"dSYUs"}],"48Qyi":[function(require,module,exports) {
var isStrictComparable = require("b7764ae3a33e7d1"), keys = require("890899114d759a77");
/**
...
},{"b7764ae3a33e7d1":"lpdGS","890899114d759a77":"6fHVw"}],"lpdGS":[function(require,module,exports) {
var isObject = require("60e8cf0004b01cf");
/**
...
},{"60e8cf0004b01cf":"cGhqJ"}],"a9Bav":[function(require,module,exports) {
/**
...
var baseIsEqual = require("d6f926078fd47849"), get = require("dcce35de4514ebec"), hasIn = require("abf46f51d909a141"), isKey = require("45e3b2b108e9de78"), isStrictComparable = require("c7b4f5bcb7c46ba9"), matchesStrictComparable = require("23a2f4ac56ade6d5"), toKey = require("b62643ea5e1d868d");
/** Used to compose bitmasks for value comparisons. */ var COMPARE_PARTIAL_FLAG = 1, COMPARE_UNORDERED_FLAG = 2;
/**
...
},{"d6f926078fd47849":"7i3qr","dcce35de4514ebec":"8UELX","abf46f51d909a141":"57qii","45e3b2b108e9de78":"4wPWG","c7b4f5bcb7c46ba9":"lpdGS","23a2f4ac56ade6d5":"a9Bav","b62643ea5e1d868d":"bEgue"}],"8UELX":[function(require,module,exports) {
var baseGet = require("a90345a3e391fe9a");
/**
...
},{"a90345a3e391fe9a":"kMRe3"}],"kMRe3":[function(require,module,exports) {
var castPath = require("e103818209ab5b18"), toKey = require("cc9548740c250ca5");
/**
...
},{"e103818209ab5b18":"apxk5","cc9548740c250ca5":"bEgue"}],"apxk5":[function(require,module,exports) {
var isArray = require("950855319fd0e7dd"), isKey = require("52ab9fedb670759c"), stringToPath = require("c849e7a0c8e2a07e"), toString = require("9d8fdbe6e1d10bc5");
/**
...
},{"950855319fd0e7dd":"dZaTH","52ab9fedb670759c":"4wPWG","c849e7a0c8e2a07e":"1m1j5","9d8fdbe6e1d10bc5":"joIdQ"}],"4wPWG":[function(require,module,exports) {
var isArray = require("41984e3866355cc7"), isSymbol = require("e85b89c52f82b6f6");
...
},{"41984e3866355cc7":"dZaTH","e85b89c52f82b6f6":"i3BHC"}],"1m1j5":[function(require,module,exports) {
var memoizeCapped = require("52856f9a88b06662");
...
},{"52856f9a88b06662":"j3xlQ"}],"j3xlQ":[function(require,module,exports) {
var memoize = require("9ab52813bddaa374");
...
},{"9ab52813bddaa374":"azHKC"}],"azHKC":[function(require,module,exports) {
var MapCache = require("7ab0930186902157");
...
},{"7ab0930186902157":"664I1"}],"bEgue":[function(require,module,exports) {
var isSymbol = require("6e541ef8992f15da");
/** Used as references for various `Number` constants. */ var INFINITY = 1 / 0;
/**
...
},{"6e541ef8992f15da":"i3BHC"}],"57qii":[function(require,module,exports) {
var baseHasIn = require("a88e4674d3b21d74"), hasPath = require("3991c9263c3d9086");
/**
...
},{"a88e4674d3b21d74":"in8KZ","3991c9263c3d9086":"4QNMG"}],"in8KZ":[function(require,module,exports) {
/**
...
var castPath = require("e5f3057d6949c0df"), isArguments = require("ebc30a3a6245165a"), isArray = require("c9a3f1c0e96c611f"), isIndex = require("fdc8bcdbae3aa8e6"), isLength = require("3591df1b2cd35b5d"), toKey = require("2c5d8fb1c5a655fd");
/**
...
},{"e5f3057d6949c0df":"apxk5","ebc30a3a6245165a":"8ReNj","c9a3f1c0e96c611f":"dZaTH","fdc8bcdbae3aa8e6":"aJpx0","3591df1b2cd35b5d":"hrTBx","2c5d8fb1c5a655fd":"bEgue"}],"8aSQI":[function(require,module,exports) {
var baseProperty = require("ee1287bdf78c3cbf"), basePropertyDeep = require("d85e1ce54595a7f7"), isKey = require("c35180cc7c2eceef"), toKey = require("75a2021f33cc958b");
/**
...
},{"ee1287bdf78c3cbf":"4HOmE","d85e1ce54595a7f7":"c9dhz","c35180cc7c2eceef":"4wPWG","75a2021f33cc958b":"bEgue"}],"4HOmE":[function(require,module,exports) {
/**
...
var baseGet = require("25d75d634b6378c0");
/**
...
},{"25d75d634b6378c0":"kMRe3"}],"ds6ZT":[function(require,module,exports) {
var toFinite = require("1f25cbcf907a4c5d");
/**
...
},{"1f25cbcf907a4c5d":"dkCNj"}],"dkCNj":[function(require,module,exports) {
var toNumber = require("cb94115c91bebf40");
...
},{"cb94115c91bebf40":"12NaH"}],"12NaH":[function(require,module,exports) {
var baseTrim = require("1069bcaeb8a6d525"), isObject = require("8aee6d119535623c"), isSymbol = require("890f2c16c224b10e");
...
},{"1069bcaeb8a6d525":"eUJZ3","8aee6d119535623c":"cGhqJ","890f2c16c224b10e":"i3BHC"}],"eUJZ3":[function(require,module,exports) {
var trimmedEndIndex = require("64c2b7813a17871b");
...
},{"64c2b7813a17871b":"hHJmS"}],"hHJmS":[function(require,module,exports) {
...
},{}],"6CcGR":[function(require,module,exports) {
module.exports = require("8bb1dae615e44831").getBundleURL("bLxZJ") + "mpg.fc40d151.csv" + "?" + Date.now();

},{"8bb1dae615e44831":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}]},["jC2qd","8lqZg"], "8lqZg", "parcelRequire6155")
